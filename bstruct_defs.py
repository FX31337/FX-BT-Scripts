...
class SymbolsRaw(BStruct):
    ...
    _fields = [
        ...
        (
            ...
            "11s",
            pretty_print_string,
        ),  # Alternative name, e.g. "AUDCAD" (if not equal 'name')
        ...
        (
            ...
            "1508c",
            pretty_print_ignore,
        ),  # ???: Some colors (use pretty_print_compact instead to print).
        (
            "unknown_2",
            "I",
        ),  # ???: E.g. 8, 10, 12, 14, 20, 24, 25, 30, 40, 50, 60, 100, 10000.
        (
            "unknown_3",
            "I",
        ),  # ???: 1 - Gold, _NQ100, 2 - Currencies, 3 - #IBM, #HPQ, etc.
        (
            "padding_1",
            "4s",
            pretty_print_compact,
        ),  # Padding space - add 4 bytes to align to the next double.
        ...
        (
            "marginDivider",
            "d",
        ),  # leverage calculation: 0...5 - relative to account leverage, > 10  - absolute custom leverage.
